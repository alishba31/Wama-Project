...
//     try {
//       const res = await axios.get("/api/oem/sla-records");
...
//       default:
//         console.warn("Unexpected SLA status:", status); // Log unknown statuses
...
//         <CardHeader>
//           <CardTitle className="text-2xl font-semibold">SLA Monitoring</CardTitle>
//         </CardHeader>
//         <CardContent>
//           {slaRecords.length === 0 ? (
